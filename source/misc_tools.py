...
def conditional_entropy(feature_data, labels):
    ...
    for each_feature in feature_names:
        ...
        for each_feature_value, each_feature_value_count in feature_value_count.items():
            def calculate_not_usefulness(label):
                ...
                label_proportion_for_feature_value = count_for_this_label/each_feature_value_count
                if count_for_this_label > 0:
                    return label_proportion_for_feature_value * math.log2(label_proportion_for_feature_value)
                else:
                    return 0
            
            feature_value_proportion = each_feature_value_count / total_samples_for_this_feature
